...
<!--THIS IS IT--><div class="content_main" >
                    ...
                    <div class="row">
                         <div class="col-lg-12">
                             <h1 class="page-header">Litsoc
                             <small>The best one out there</small>
                             </h1>
                        </div>
                  ...
                  <ol class="breadcrumb">
                    ...
                    </li><li><a href="index.html">Socities</a>
                    </li>
                    <li class="active">Name of society</li>
                </ol>
    <!-- Page Content -->
    <div class="container">
