...
if(isset($_SESSION['blogger'])){
         header("Location: http://thaparexpress.in/add_blog.php");
    exit();
}?>
<!DOCTYPE html>
<html>
...
<body>
				...
				<form method="post" action="login.php">
					...
					<li>
						<input name="blogger" required="required" id="blogger" type="text" class="text"  placeholder="Blogger Username">
					</li>
					<li>
					...
					<div class="p-container">
								...
								<a   href="../login/index.php" class="reg_button">User Sign In</a>
