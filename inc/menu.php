					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller">
							<ul class="gn-menu">
								...
								<li><a   href="../societies.php?id=dep"  class="gn-icon  menu_items gn-icon-societies">Societies</a>
                                <li><a   href="../events.php" class="gn-icon  menu_items gn-icon-calendar">Events</a>
								<ul class="gn-submenu">
                                        <li><a   href="../event_mega.php" class="gn-icon menu_items  gn-icon-rocket">Elixr</a></li>
                                        </ul></li>
